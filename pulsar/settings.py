...
CANONICAL_HOST = os.getenv("DOMAIN_NAME", "pulsar.pub")
if LOCALDEV:
    CANONICAL_HOST = "pulsarlocal.pub:8000"
...
if os.getenv("SQLITE", "") != "1":
    ...
    # e.g. postgres://pulsar:password@127.0.0.1:5432/pulsar
    database_name = database_url.path[1:]  # url.path is '/pulsar'
    DATABASES = {
        "default": {
